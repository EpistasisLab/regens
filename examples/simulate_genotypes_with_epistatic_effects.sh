#!/bin/bash
#BSUB -J simulate_genotypes_with_epistatic_effects
#BSUB -o simulate_genotypes_with_epistatic_effects.out
#BSUB -e simulate_genotypes_with_epistatic_effects.err
